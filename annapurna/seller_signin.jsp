...
<body>
       ...
       <div class="row mb-5" id="row-c1">
           <div class="col-4 border  my-5  mx-auto px-3 shadow">
             ...
             <div class= "row  text-center bg-light mb-5 text-white">
               <div class="col-6 bg-info p-0"><a class="btn btn-info n  btn-block">SignIn as Seller</a></div>
               <div class="col-5 p-0"> <a  href="buyer_signin.jsp" class="btn btn-light n btn-block">SignIn as Buyer</a></div>  
               <div class="col-1 bg-light"><a href="index.jsp"><h4><li class="fa fa-times text-info text-center p-0"></li></h4></a></div>
               </div>
                     
              <form action="seller_signin.do" method="post" class="w-75 " id="form">
   ...
   <script type="text/javascript" src="static/js/seller_signin.js"></script>   
 </body>
</html>